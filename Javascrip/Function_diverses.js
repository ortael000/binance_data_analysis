...
function convert_table_html (table) {  // fonction qui convertir une table js en un texte qui correspond au code pour creer la table en html
...
function csvToArray2(csv, delimiter = ",", omitFirstRow = true) {
